...
class Game {
  ...
  initializeGame() {
    ...
    console.log('From the distance you spot the battlemaster, you approach the man and are met with an unimpressed stare. Determined you ask to participate in the brutal death-matches this arena is known for');

    console.log('Smirking the battlemaster looks at you and asks...')
    ...
    if (this.isPlayerTurn) {
      ...
      .then(({ action }) => {
        if (action === 'Use potion') {
          ...
          const attackDescription = this.attackDescription.getRandomAttackDescription();
    
          // Declare attack and showcase enemy health
          console.log(`You ${attackDescription} the ${this.currentEnemy.name}`);
      ...
      // Declare attack and showcase player health
