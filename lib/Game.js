...
class Game {
  ...
  purchaseEquipment(purchasedItem) {
    ...
    // deduct player GP with price of gear
    
    // if player bought weapon, update BA and damage

    // else if they bought armor update AC

    // Log the item players have purchasd
    // Showcase updated stats
