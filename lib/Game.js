...
class Game {
  ...
  showWeaponInventory() {
    const weaponData = [
      { name: 'Weapon1', price: 10 + 'GP', damage: 15, Attack_Bonus: '+' + 2},
      { name: 'Weapon2', price: 20 + 'GP', damage: 25, Attack_Bonus: '+' + 4},
    ];

    console.log('Here are the available weapons:');
    console.table(weaponData);
  ...
  showArmorInventory() {
    const armorData = [
      { name: 'ArmorSet1', price: 30 + 'GP', Armor_Bonus: '+' + 2},
      { name: 'ArmorSet2', price: 50 + 'GP', Armor_Bonus: '+' + 4},
    ];

    console.log('Here are the available armor pieces');
    console.table(armorData);
  ...
  purchaseEquipment(purchasedItem) {
    ...
    // deduct player GP with pirce of gear
