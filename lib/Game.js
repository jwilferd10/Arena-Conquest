...
class Game {
  constructor() {
    ...
    this.weaponData = [
      { name: 'Weapon1', price: 10, damage: 15, Attack_Bonus: 2, category: 'Weapon'},
      { name: 'Weapon2', price: 20, damage: 25, Attack_Bonus: 4, category: 'Weapon'},
    ];
    this.armorData = [
      { name: 'ArmorSet1', price: 30, Armor_Bonus: 2, category: 'Armor'},
      { name: 'ArmorSet2', price: 50, Armor_Bonus: 4, category: 'Armor'},
    ];
  };
