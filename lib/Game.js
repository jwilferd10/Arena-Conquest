...
class Game {
  ...
  purchaseEquipment(purchasedItem) {
    ...
    if (purchasedItem.category === 'Weapon') {
      item = weaponData.find(weapon => weapon.name === purchasedItem.name);
      this.purchaseWeapon(item);
      // console.log('Player has bought a weapon!');
    } else if (purchasedItem.category === 'Armor') {
      item = armorData.find(armor => armor.name === purchasedItem.name);
